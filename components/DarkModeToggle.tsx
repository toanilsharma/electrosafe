...
export const DarkModeToggle: React.FC<Props> = ({ dark, onToggle }) => (
  ...
  >
    <span
      className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white shadow flex items-center justify-center transition-transform duration-300 ${dark ? 'translate-x-6' : 'translate-x-0'}`}
    >
