        ...
        <div className={`p-8 rounded-xl border-2 ${resultData.bg} ${resultData.border}`}>
          <div className="text-center">
            ...
            <div className="mt-8 no-print text-left">
              <h3 className="text-lg font-bold text-gray-900 mb-4">❓ Common Electrical Safety Questions</h3>
              <div className="space-y-3">
                {FAQ_DATA.map((faq, i) => (
                  <details key={i} className="bg-white rounded-xl border border-gray-200 p-4 group cursor-pointer">
                    <summary className="font-bold text-gray-900 text-sm list-none flex justify-between items-center">
                      {faq.q}
