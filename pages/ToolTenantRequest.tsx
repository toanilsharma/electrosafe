  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100">Tenant & Student Request Generator</h1>
        <p className="mt-2 text-gray-600 dark:text-gray-400 dark:text-gray-400 max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-gray-900 dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 dark:border-gray-700">
          <h2 className="text-lg font-bold text-gray-800 dark:text-gray-200 dark:text-gray-200 mb-6 flex items-center gap-2">
            <AlertTriangle className="w-5 h-5 text-blue-600" /> Describe the Problem
          </h2>

          <div className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">What is the issue?</label>
              <select
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2 bg-gray-50 dark:bg-gray-800 dark:bg-gray-800 p-2 rounded">
                <strong>Technical Term:</strong> {selectedIssue.technicalTerm}
              </p>
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Where is it located?</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Who are you sending this to?</label>
              <div className="flex gap-4">
                <button
                  onClick={() => setRecipient('Landlord')}
                  className={`flex-1 py-2 rounded-md text-sm font-medium border ${recipient === 'Landlord' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'bg-white dark:bg-gray-900 dark:bg-gray-900 border-gray-300 text-gray-600 dark:text-gray-400 dark:text-gray-400'}`}
                >
                  Landlord
                </button>
                <button
                   onClick={() => setRecipient('Warden')}
                   className={`flex-1 py-2 rounded-md text-sm font-medium border ${recipient === 'Warden' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'bg-white dark:bg-gray-900 dark:bg-gray-900 border-gray-300 text-gray-600 dark:text-gray-400 dark:text-gray-400'}`}
                >
                  Hostel Warden
                </button>
              </div>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="bg-gray-100 dark:bg-gray-800/50 dark:bg-gray-800/50 p-6 flex-grow border-x border-gray-200 dark:border-gray-700 dark:border-gray-700">
            <textarea
              readOnly
              className="w-full h-64 p-4 rounded-lg text-gray-800 dark:text-gray-200 dark:text-gray-200 font-mono text-sm border-0 focus:ring-0 resize-none bg-white dark:bg-gray-900 dark:bg-gray-900 shadow-inner"
              value={generateMessage()}
            />
          </div>
          <div className="bg-white dark:bg-gray-900 dark:bg-gray-900 p-6 rounded-b-xl border-x border-b border-gray-200 dark:border-gray-700 dark:border-gray-700 flex flex-col sm:flex-row gap-4">
            <button
              onClick={handleCopy}
            ...
            >
             ...
             <a
              ...
              className="flex-1 flex items-center justify-center gap-2 py-3 bg-gray-100 dark:bg-gray-800/50 dark:bg-gray-800/50 text-gray-700 dark:text-gray-300 dark:text-gray-300 rounded-lg hover:bg-gray-200 font-bold border border-gray-300"
            >
