  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-3">Home Electrical Safety in India</h1>
        <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400 text-lg max-w-2xl mx-auto">IS 732 standards, monsoon preparedness, inverter safety, and BEE ratings — tailored for Indian homes.</p>
      </div>
      ...
      {/* Tips Grid */}
      <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-6">🔑 India-Specific Safety Tips</h2>
      ...
      <div className="space-y-4 mb-10">
        ...
        {[
          ...
          <div key={i} className="bg-white dark:bg-gray-900 dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 dark:border-gray-700 p-5">
            <h3 className="font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-2">Q: {faq.q}</h3>
            <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 text-sm">{faq.a}</p>
          </div>
        ))}
      </div>
